...
PerformanceTests.new = function(self, _fnOnReadyCallback)
	...
	local tInitSettings = {
		sViewName = "PerformanceTests",
		sViewAddress = "coui://UIGameface/PerformanceTests.html",
		bStartEnabled = true,
